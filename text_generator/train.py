...
with open(input_text,'r',encoding='utf-8') as txt:
    new_lines = txt.readlines()[0]      # 불러올때 차원이 하나 더생김
...
input_list = [None] * total_range   # total_range만큼의 [None]를 만들어 논다.
output_list = [None] * total_range  # [] = 빈 리스트
...
print('shape',input_list.shape[1])
